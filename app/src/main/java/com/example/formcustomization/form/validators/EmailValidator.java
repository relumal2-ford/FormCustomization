...
public class EmailValidator implements InputValidator {
    ...
    private static final String ROMAN_LETTER_CHARACTERS = "A-z";
    private static final String NUMBER_CHARACTERS = "0-9";
    private static final String LETTER_CHARACTERS = ROMAN_LETTER_CHARACTERS + "àáâäãåæçèéêëìíîïóôöòõœùúûüñýÿðø¿¡ºªÀÁÂÄÅÃÆÇÐÈÉÊËÌÍÎÏÓÔÖÒÕŒÙÚÛÜÑÝŸØÞþßÁČĎÉĚÍŇÓŘŠŤÚŮÝŽáčďéěíňóřšťúůýžÖŐÜŰöőüűĂÂÎȘȚŞŢăâîșțşţΑΆΒΓΔΕΈΖΗΉΘΙΊΚΛΜαάβγδεέζηήθιίκλμϊΐΝΞΟΌΠΡΣΤΥΎΦΨΧΩΏ·νξοόπρστυύφχψωώςϋΰāēūīōĒŪĪŌĀẞŠŻŹĆŃęėįīśżźćńĘĖĮŚ";
    private static final String ALPHANUMERIC_CHARACTERS = LETTER_CHARACTERS + NUMBER_CHARACTERS;
    private static final String EMAIL_VALID_CHARACTERS = ALPHANUMERIC_CHARACTERS + "\\-_";
    private static final String EMAIL_REGEX = "^[" + EMAIL_VALID_CHARACTERS + "]+" + "(\\.[" + EMAIL_VALID_CHARACTERS + "]+)*" +"@[" + EMAIL_VALID_CHARACTERS + "]+" + "(\\.["+ EMAIL_VALID_CHARACTERS +"]+)*\\.[" + LETTER_CHARACTERS + "]{2,}$";
