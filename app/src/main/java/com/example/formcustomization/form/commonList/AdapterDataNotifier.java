...
public class AdapterDataNotifier {
    ...
    @Inject
    public AdapterDataNotifier() {}

    public void notifyDataChange(PagerAdapter adapter) {
    ...
    public void notifyItemRangeChanged(RecyclerView.Adapter adapter, int positionStart, int itemCount) {
        adapter.notifyItemRangeChanged(positionStart, itemCount);
    }

    public void notifyItemChanged(RecyclerView.Adapter adapter, int position) {
        adapter.notifyItemChanged(position);
    }

    public void notifyItemRemoved(RecyclerView.Adapter adapter, int position) {
