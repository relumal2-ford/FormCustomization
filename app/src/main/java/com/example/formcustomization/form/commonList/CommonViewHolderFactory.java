...
public class CommonViewHolderFactory {
    ...
    @Inject
    public CommonViewHolderFactory() {
    }

    public CommonViewHolder create(ViewGroup parent, @LayoutRes int layoutId) {
        return new CommonViewHolder(DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), layoutId, parent, false));
    }
}